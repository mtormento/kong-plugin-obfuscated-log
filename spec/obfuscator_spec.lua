...
local obfuscator = require('../common/obfuscator')
...
TestObfuscate = {} --class
    ...
    function TestObfuscate:testInvalidJson()
        ...
        lu.assertEquals( errorMsg, './///common/obfuscator.lua:53: Expected value but found unexpected end of string at character 23')
    end
-- class TestObfuscate
